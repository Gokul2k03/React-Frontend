    ...
    return (
        <div>
                ...
                <div style={{marginRight: '3%', width: '200px', paddingTop: '15px', paddingBottom: '15px'}} class="btn-group">
                    {user_signed_in ? <>
                        ...
                        <div style={{display: 'flex'}}>
                            <img style={{marginTop: '-4px', width: '40px', height: '40px'}} class="u4" src={u4} alt='profile pic'/>
            ...
            <div style={{backgroundColor: 'black'}}>
                ...
                {!breaking_point_desktop && <>
                <p>
                    <img alt='back' src={arrowback} style={{cursor: 'pointer', position: 'absolute', marginTop: (breaking_point_mobile ? '-275px' : '-183px'), marginLeft: '3.75%'}}/>
                </p>
                {user_signed_in ? 
                <button onClick={() => setUser_signed_in(false)} style={{position: 'absolute', borderColor: 'white', color: 'white', borderRadius: '4px', marginTop: (breaking_point_mobile ? '-298px' : '-205px'), right: '0', marginRight: '3.75%'}} class="btn btn-sm" type="button">Leave Group</button>:
            ...
            <div class="card-body">
                ...
                <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <h6 style={{fontSize: '15px', fontWeight: '700', marginTop: '10px'}}>Sarthak Kamra</h6>
                    </div>
                    <div style={{display: 'flex'}}>
            ...
            <div class="card-body">
                ...
                <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <p style={{fontWeight: '700', width:'90%'}} class="card-text">Tax Benefits for Investment under National Pension Scheme launched by Government</p>
                    <div class="btn-group">
                        <button style={{height: '25px', width: '25px'}} type="button" class="btn" data-bs-toggle="dropdown" aria-expanded="false">
                            <img style={{marginTop: '-16px', marginLeft: '-8px'}} alt='...' src={menuicon} />
                        </button>
                ...
                <div style={{display: 'flex'}}>
                    ...
                    <h6 style={{fontSize: '15px', fontWeight: '700', marginTop: '10px'}}>Sarah West</h6>
                </div>
                <div style={{display: 'flex'}}>
                    <img alt='views' style={{width: '18px', height: '18px', marginTop: '10px'}} src="https://img.icons8.com/material-outlined/24/525252/visible--v1.png"/>
                    <p style={{fontSize: '15px', color: '#525252', marginTop: '7.5px', marginBottom: '0px'}}>1.4k views</p> 
                ...
                <div style={{display: 'flex'}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'column'}}>
                        <h6 style={{fontSize: '15px', fontWeight: '700'}}>Sarah West</h6>
                        <p style={{fontSize: '15px', color: '#525252', marginTop: '-8px', marginBottom: '0px'}}>4.8k views</p>
                    </div>
                </div>
                <div style={{display: 'flex'}}> 
                    <button class="btn" style={{backgroundColor: '#EDEEF0'}} type="button">
            ...
            <div class="card-body">
                ...
                <div style={{display: 'flex'}}>
                    <img alt='views' style={{marginTop: '2px', width: '15px', height: '15px'}} src={calendericon} />
                    <p style={{fontSize: '14px', color: 'black'}}>Fri, 12 Oct, 2018</p>
                    <img alt='views' style={{marginTop: '2px', width: '10px', height: '15px'}} src={locationicon} />
                ...
                <div style={{display: 'flex'}}>
                    ...
                    <h6 style={{fontSize: '15px', fontWeight: '700', marginTop: '10px'}}>Ronal Jones</h6>
                </div>
                <div style={{display: 'flex'}}>
                    <img alt='views' style={{width: '18px', height: '18px', marginTop: '10px'}} src="https://img.icons8.com/material-outlined/24/525252/visible--v1.png"/>
                    <p style={{fontSize: '15px', color: '#525252', marginTop: '7.5px', marginBottom: '0px'}}>1.4k views</p> 
            ...
            <div class="card-body">
                ...
                <div style={{display: 'flex'}}>
                    <img alt='views' style={{marginTop: '2px', width: '15px', height: '15px'}} src={jobicon} />
                    <p style={{fontSize: '14px', color: 'black', width: (breaking_point_desktop ? '' : '150px'), overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>Innovaccer Analytics Private Ltd.</p>
                    <img alt='views' style={{marginTop: '2px', width: '10px', height: '15px'}} src={locationicon} />
                ...
                {breaking_point_desktop ? <>
                <div style={{display: 'flex'}}>
                    <img style={{width: '40px', height: '40px'}} src={u4} class="u4" alt='user1' />
                    <h6 style={{fontSize: '15px', fontWeight: '700', marginTop: '10px'}}>Joseph Gray</h6>
                </div>
                <div style={{display: 'flex'}}>
                    <img alt='views' style={{width: '18px', height: '18px', marginTop: '10px'}} src="https://img.icons8.com/material-outlined/24/525252/visible--v1.png"/>
                    <p style={{fontSize: '15px', color: '#525252', marginTop: '7.5px', marginBottom: '0px'}}>1.4k views</p> 
                ...
                <div style={{display: 'flex'}}>
                    <img style={{width: '40px', height: '40px'}} class="u4" src={u4} alt='user1' />
            ...
            {breaking_point_desktop && <div className='wholeright'>
                ...
                <br />
                <h6>
                <img style={{marginTop: '-5px'}} src={likeicon} alt='rec'/> RECOMMENDED GROUPS
                </h6>
            ...
            <button className='closebtn' style={{position: 'relative', backgroundColor: 'transparent', border: 'none', top: '200px'}} type="button" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div style={{marginLeft: '10px', marginRight: '10px', display: 'flex', justifyContent:'space-between'}}>
                        ...
                        <p style={{fontSize: '15px'}}>Already have an account? 
                            <span data-bs-toggle="modal" data-bs-target="#signupmodal" data-bs-dismiss="modal" style={{cursor: 'pointer', color: 'blue'}}>Sign In</span>
                        </p>
                    </div>
                    <br />
                ...
                <div class="modal-body">
                    <div style={{marginLeft: '10px', marginRight: '10px', display: 'flex', justifyContent:'space-between'}}>
                        ...
                        <p style={{fontSize: '15px'}}>Don't have an account yet? 
                            <span data-bs-toggle="modal" data-bs-target="#createaccountmodal" data-bs-dismiss="modal" style={{cursor: 'pointer', color: 'blue'}}>Create new for free!</span>
                        </p>
                    </div>
                    <br />
                    <div style={{marginBottom: '5px', marginLeft: '10px', marginRight: '10px', display: 'flex', justifyContent: 'space-evenly'}}>
            ...
            <div class="offcanvas-header">
                ...
                <button style={{marginBottom: '-5px'}} type="button" class="btn text-reset" data-bs-dismiss="offcanvas" aria-label="Close">
            ...
            <img style={{cursor: 'pointer'}} alt='float' src={float} /></a>}
        </div>
    )
}
